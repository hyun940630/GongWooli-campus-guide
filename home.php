...
<html>
  <head>
    ...
    <script src="./script/date.js?ver=1"></script>
    <script src="./script/slide.js?ver=1"></script>
    <script src="./script/stt.js?ver=1"></script>
    <script src="./script/search_fnr.js?ver=1"></script>
    <script src="./script/voice_dialog.js?ver=1"></script>
    <script src="./script/calendar.js?ver=1"></script>

    <!-- COMMON -->
    <link rel="stylesheet" href="./style/common/home.css?ver=1">
    <link rel="stylesheet" href="./style/common/slide.css?ver=1">
    <link rel="stylesheet" href="./style/common/search_input.css?ver=1">
    <link rel="stylesheet" href="./style/common/scrollbar.css?ver=1">

    <!-- PAD -->
    <link rel="stylesheet" href="./style/pad/home_p.css?ver=1">

    <!-- DESKTOP -->
    <link rel="stylesheet" href="./style/desktop/home_d.css?ver=1">

    <!-- KIOSK -->
    <link rel="stylesheet" href="./style/kiosk/home_k.css?ver=1">
  </head>
  <body>
    <div class="container">
      <div id="sidebar">
          ...
          <ul class="nano-content">
            ...
            <li class="sub-menu">
              ...
              <ul id="9-0-0" class="depth-1">
                ...
                <li><a href="javascript:requestByMenu('I01-2325-01');">2325호 공학교육원</a></li>
      ...
      <div class="main-content">
        ...
        <section>
          ...
          <div class="content_wrap">
            <div class="transparent_wrap">
              <div class="dept_title_wrap">
                <div class="link_wrap">
                  <span>창의공과대학 길찾기 안내시스템</span><br><span>(http://ecguide.wku.ac.kr)</span>
                </div>
            ...
            <div class="opaque_wrap">
              <div class="app_title_wrap">
                <div class="app_logo_wrap">
                  <img class="wku_logo" src="./img/wku_logo.jpg" alt="wku_logo">
                </div>
                <div class="app_name_wrap">
                  <span>길찾기 어플리케이션</span>
                </div>
              </div>
              ...
              <div class="buttons_wrap">
                ...
                <!-- https ssl 인증 문제 해결 후 음성인식 기능 사용
                <div id="voice_rec" class="btn">
                    <a href="javascript:openVoiceDialog();"><img src="./img/mic_btn.png" alt="voice_rec"></a>
                </div> -->
              </div>
            </div>
          </div>
